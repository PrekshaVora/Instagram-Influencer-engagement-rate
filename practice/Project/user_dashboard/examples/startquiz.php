...
$sql = "select * from attemptquiz";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    echo "<table style='width:100%;'><tr><th>Sr.No</th><th>Test Name</th><th>   Start</th></tr>";
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>" . $row["Sr.No"]. "</td><td>" . $row["test_name"]. "</td><td><button style='background-color:#2471A3; width:50%;'><a href='../Project/home.php' style='color:white;'> " . $row["attempt_button"]. "</a></button></td></tr>";
    }                                                                                                                                                                                                           
    echo "</table>";
} else {
    echo "0 results";
